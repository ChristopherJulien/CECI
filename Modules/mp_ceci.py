...
class Widget():
    ...
    def calibrate(self):
        ...
        experiment_folder = master_folder_path + r"/" + "Experiment"
        ...
        total_seconds = 30
        saleae_COM = self.combobox_2.get()
        saleae_channels = self.segmented_button_2.get()
        saleae_buffer_size = self.combobox_2_1.get()
        saleae_sampling_rate = self.combobox_2_2.get()
        saleae_device_id = self.entry_2.get()
        ...
        parameters_dict = {"master_folder_path": master_folder_path, "experiment_folder": experiment_folder, "calibration_subfolder": calibration_subfolder, "voltages_subfolder": voltages_subfolder, 'voltages_analog_subfolder': voltages_analog_subfolder,
                           "total_seconds": total_seconds, "salea   e_COM": saleae_COM, "saleae_channels": saleae_channels, "saleae_buffer_size": saleae_buffer_size, "saleae_sampling_rate": saleae_sampling_rate, "saleae_device_id": saleae_device_id}
