...
max_p1 = 400 if not calibration_flag else 10
nb_steps1 = 40 if not calibration_flag else 10
# or by number of steps: step_size = int((Pmax - Pmin) / 20.)

start_p2 = 0 if not calibration_flag else 0
max_p2 = 400 if not calibration_flag else 10
nb_steps2 = 40 if not calibration_flag else 10
